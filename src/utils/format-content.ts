 ...
 * Slugify a headline
 *
 * @param headline - The headline to slugify
 *
 * @returns The slugified headline
 *
 * @example
 * slugifyHeadline("About Us") // returns "about-us"
 */
...
/**
 * Use sanitize content.
 *
 * @param {string} description - The description to sanitize.
 *
 * @example
 * useSanitizeContent({ description: "Hello World" });
 * // returns "Hello World"
 *
 * @example
 * useSanitizeContent({ description: "<script>alert('Hello World')</script>" });
