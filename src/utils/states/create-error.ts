...
export type CreateErrorInput = string | (CreateErrorOptions & Record<string, unknown>)
 ...
 *
 * @param input - The input to create the error from
 * @param overrides - Optional overrides for the error options
 *
 * @example
 * const error = createError("BAD_REQUEST", { message: "Custom message" });
 * // returns a normalized error with status code 400
 */
