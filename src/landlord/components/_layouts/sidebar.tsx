...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      {/* Scrollable nav area */}
      <nav className="flex-1 overflow-y-auto overscroll-contain scrollbar-none grid content-start gap-1">
        {/* Dashboard */}
        <NavLink
        ...
        <div>
          ...
          >
            ...
            <span className="flex flex-col flex-1 min-w-0">
              ...
              <span className={cn("text-xs mt-0.5", isQuestsGroupActive ? "text-white/35" : "text-white/35")}>
