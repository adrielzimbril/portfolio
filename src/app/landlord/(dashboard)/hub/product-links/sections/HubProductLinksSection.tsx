      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-black/45">
            Gérer les liens privés envoyés par mail pour chaque ressource du
            Hub.
          </p>
        </div>
                          ...
                          <td className="px-5 py-4">
                            <div className="flex items-center gap-2">
                              <Input
                                ...
                                className="text-sm border-black/8 focus-visible:ring-black/10"
                                disabled={isUpdating}
                              />
                            </div>
                          </td>
          ...
          <div className="p-6">
            <div className="flex flex-col items-center gap-3 text-center text-sm text-black/50">
              ...
              <div>
                ...
                <p className="text-xs">Vérifiez vos content collections.</p>
              </div>
            </div>
          </div>
        )}
