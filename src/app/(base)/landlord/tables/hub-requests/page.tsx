...
import { HubRequestsTablePage } from "@/components/shared/pages/landlord/HubRequestsTablePage";

export default async function HubRequestsTablePage() {
  ...
  try {
    ...
    logger.error("[HubRequestsTablePage] Failed to fetch user data", error);
  }
