    ...
    <nav className="w-full h-28 bg-greys-00">
      <div className="flex items-center justify-between px-[153px] pt-14">
        ...
        <div className="flex items-center justify-center gap-4 px-1 py-0 rounded-2xl border-2 border-solid border-[#f9f9f9]">
          {navigationItems.map((item, index) => (
            <div key={index} className="flex flex-col items-center gap-[3px]">
              ...
              >
                <div className="[font-family:'SF_Pro_Text-Regular',Helvetica] font-normal text-[17px] tracking-[0.07px] leading-[22px] whitespace-nowrap">
                  <span
                    className={
                      item.isActive
                        ? "text-[#000000de]"
        ...
        <Button className="px-6 py-[13px] bg-greys-08 rounded-xl h-auto hover:bg-greys-08/90">
          <div className="font-SF-pro-medium-17-m font-[number:var(--SF-pro-medium-17-m-font-weight)] text-text-iconsdark-high-emphasis text-[length:var(--SF-pro-medium-17-m-font-size)] tracking-[var(--SF-pro-medium-17-m-letter-spacing)] leading-[var(--SF-pro-medium-17-m-line-height)] whitespace-nowrap [font-style:var(--SF-pro-medium-17-m-font-style)]">
            Parler de SaaS 👋
          </div>
        </Button>
      </div>
