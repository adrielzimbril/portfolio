...
import { getAnonymousUserId, syncAnonymousReactionsOnLogin } from "@/lib/reactions/anonymous-user"
...
export function SyncProvider({ children }: { children: React.ReactNode }) {
  ...
  return <SyncContext.Provider value={{ hasSynced }}>{children}</SyncContext.Provider>
}
