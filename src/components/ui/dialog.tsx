...
function DialogContent({
  ...
  const variantClasses = {
    ...
    modern:
      "squircle squircle-sh-white/99 squircle-2xl md:squircle-5xl squircle-smooth-lg md:squircle-smooth-xl squircle-border-4 squircle-border-b-base-accent",
    glass:
      "squircle squircle-sh-white/99/80 squircle-2xl md:squircle-5xl squircle-smooth-lg md:squircle-smooth-xl backdrop-blur-xl squircle-border-4 squircle-border-b-base-accent",
  };
