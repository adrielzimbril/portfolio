    ...
    <>
      <textarea
        ...
        className={cn(
          ...
          className,
          autoGrow && "field-sizing-content max-h-29.5 min-h-0 resize-none py-1.75",
      ...
      {showLimit && limit !== Infinity && (
        <p
          ...
          aria-live="polite"
        >
          <span className="tabular-nums">{maxLength - characterCount}</span> {t("common.shared.text.characters-left")}
        </p>
      )}
    </>
  )
