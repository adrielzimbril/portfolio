...
function TooltipArrow({ side }: TooltipArrowProps) {
  return (
    <div
      className={cn(
        "absolute bg-b-white-invert-sec z-50 size-2.5 rotate-45 rounded-[2px]",
        ...
        <TooltipPortal>
          ...
          >
            <motion.div
              ...
              transition={transition}
              className="relative rounded-lg bg-b-white-invert-sec fill-primary px-3 py-1.5 text-sm text-b-white-invert-foreground shadow-md w-fit text-balance"
            >
