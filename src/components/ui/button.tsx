...
const buttonVariants = cva(
  "inline-flex squircle-7xl/100 hover:squircle-3xl/100 items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-inherit bg-primary border-2 border-primary text-b-black-unchanged hover:bg-primary/90",
        base: "bg-inherit bg-b-base border-0 border-transparent hover:bg-b-base/90",
        secondary: "bg-inherit bg-sh-white border-2 border-b-base-accent text-b-white-invert",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "bg-inherit bg-transparent border-2 border-b-base-accent",
        colored: "bg-inherit text-b-black-unchanged",
