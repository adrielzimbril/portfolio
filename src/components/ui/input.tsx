      ...
      <>
        <input
          ...
          className={cn(
            ...
            type === "file" &&
              "text-muted-foreground/70 file:border-zinc-200 file:text-foreground p-0 pr-3 italic file:me-3 file:h-full file:border-0 file:border-r file:border-solid file:bg-b-white file:px-3 file:text-lg file:font-medium file:not-italic",
