...
export function StatsPageHeader() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-10 left-10 w-32 h-32 squircle-primary/10 rounded-full blur-3xl -z-10"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      />
      <motion.div
        className="absolute top-10 right-10 w-32 h-32 squircle-accent/10 rounded-full blur-3xl -z-10"
        animate={{
          scale: [1, 1.15, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
