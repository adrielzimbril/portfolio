...
export function GitHubStatsCard({
  ...
  const cardClassName = cn(
    "group relative flex h-full flex-col overflow-hidden border border-border bg-b-base p-4 transition-all duration-300 hover:border-primary hover:bg-sh-white",
