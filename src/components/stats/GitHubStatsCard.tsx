...
export function GitHubStatsCard({
  ...
  const cardClassName = cn(
    "group relative flex h-full flex-col overflow-hidden squircle-border-border squircle-b-base p-4 transition-all duration-300 hover:squircle-border-primary hover:squircle-sh-white",
    ...
    return (
      <div className={cardClassName}>
        ...
        <div className="relative z-20 flex h-full flex-col">
          <h2 className="mb-1 text-sm font-medium text-foreground">{label}</h2>
    ...
    >
      ...
      <div className="relative z-20 flex h-full flex-col">
        ...
        <motion.p
          ...
          className="mt-auto text-2xl font-semibold tracking-tight text-foreground"
        >
          {displayValue.toLocaleString()}
        </motion.p>
      </div>
