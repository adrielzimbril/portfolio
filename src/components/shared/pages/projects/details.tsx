...
import { ProjectCategories, ProjectTags } from "@/components/shared/pages/projects/tags"
...
export function CardInfo({
  ...
  return (
    <div className={cn("flex flex-col flex-1 items-start justify-between gap-4 size-full", isWide && "justify-center")}>
...
function Action({ slug }: { slug: string }) {
  ...
  return (
    <Link href={getResourcesUrl(PageType.PROJECT, slug)} likeButton whileTap size="xs" asIcon>
