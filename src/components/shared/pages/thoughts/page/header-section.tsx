...
export function HeaderSection({
  ...
  return (
    ...
    >
      {/* Header Preview Card */}
      <Card className="w-full squircle squircle-sh-white/100 squircle-smooth-xl squircle-2xl md:squircle-4xl overflow-hidden p-3 md:p-5">
        <CardContent
          className={cn(
      ...
      {tags && tags.length > 0 && (
        <div className="flex flex-wrap items-start gap-1.5 px-1 py-1 w-full squircle squircle-smooth-xl squircle-2xl md:squircle-7xl squircle-sh-white/100 overflow-hidden">
          {tags.map((tag, index) => (
