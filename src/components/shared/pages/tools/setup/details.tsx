...
export function CardInfo({
  ...
  return (
    <div className="flex flex-col items-start justify-center gap-4 size-full">
      ...
      <Tags primaryTag={translatedCategory} primaryTagColor={DEFAULT_COLOR_CODE_NAME.ORANGE} tags={translatedTags} />
...
function Description({ description }: { description: string }) {
  return <p className="w-full relative text-base text-b-white-invert-thr leading-6">{description}</p>
}
