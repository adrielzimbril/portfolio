  ...
  return (
    <div
      className={cn(
        ...
        variant === "squircle" &&
          "squircle squircle-sh-white/99 squircle-smooth-xl squircle-6xl squircle-border-8 md:squircle-border-12 squircle-border-b-base-accent aspect-square size-full md:size-96 p-12 overflow-hidden",
