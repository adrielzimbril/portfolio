...
export function EmojiPlaceholder({
  ...
  return (
    <div
      ...
      className={cn(
        "row-1 relative flex items-center justify-center size-full w-[stretch]! cursor-pointer transition-transform duration-300 hover:scale-105",
        ...
        variant === "squircle" &&
          "bg-sh-white squircle-7xl/100 border-8 md:border-12 border-b-base-accent aspect-square size-full md:size-96 p-12 overflow-hidden",
