...
export function PreviewValueCardDetails({ icon, badge, title, description }: CardInfoProps) {
  return (
    <div
      className={cn(
        "flex relative flex-col gap-12 md:gap-16 min-h-60 items-start justify-between px-6 py-8 md:px-8 md:py-14 squircle-2xl/60 md:squircle-4xl/60 bg-sh-white overflow-hidden",
      )}
    >
      <div className="flex flex-row items-center justify-between w-full mx-auto">
        <Badge className="capitalize h-auto" size="md">
          {badge}
        </Badge>
