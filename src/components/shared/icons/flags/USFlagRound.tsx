      ...
      <svg width={width} height={height} fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#a)">
          <path
            ...
            fill="#C42126"
          />
          <path d="M20.729 5.85h7.64a16.077 16.077 0 0 0-3.13-2.91H19.5c.475.835.883 1.82 1.228 2.91Z" fill="#E7E7E7" />
          <path
          ...
          <path
            ...
            fill="#F3F4F5"
          />
          <path d="M.62 20.407h21.778c.102-.953.17-1.928.204-2.91H.072c.093 1 .28 1.972.548 2.91Z" fill="#E73625" />
          <path
          ...
          <path
            ...
            fill="#E73625"
          />
          <path d="M15.67.008C7.47.175.786 6.505.067 14.558H15.67V.008Z" fill="#283991" />
          <path
