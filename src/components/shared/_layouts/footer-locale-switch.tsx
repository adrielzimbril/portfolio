...
export function FooterLocaleSwitch() {
  ...
  const currentIcon = Object.entries(locales).find(([locale]) => locale === currentLocale)?.[1]
    .icon as keyof typeof iconsMap
            ...
            return (
              ...
              >
                ...
                <span className="text-xl">
                  <IconComponent width="20px" height="15px" className="rounded-xs" />
                </span>
              </DropdownMenuRadioItem>
            )
          })}
