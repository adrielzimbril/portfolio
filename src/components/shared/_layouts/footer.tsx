  ...
  return (
    <footer className="w-full">
      <SectionBase
        ...
        className="squircle squircle-sh-white/99 squircle-xl md:squircle-3xl squircle-smooth-xl rounded-3xl border-0 overflow-hidden max-w-none"
      >
  ...
  return (
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          className="flex w-fit items-center gap-2 squircle-sh-white/99! text-b-white-foreground min-w-10"
          size="xs"
          asIcon
          asPointer
          aria-label="Language"
