...
export const signInWithGithub: AuthHandler["signInWithGithub"] = async (callbackURL?) => {
...
export const signInWithGoogle: AuthHandler["signInWithGoogle"] = async (callbackURL?) => {
  const url = new URL(window.location.origin + authRoutes.login)
