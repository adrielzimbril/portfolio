...
import { GetSignedUploadUrlHandler, GetSignedUrlHandler, UploadHandler } from "@/integrations/storage/types/types"
...
export const getSignedUrl: GetSignedUrlHandler = async (path, { bucket, expiresIn = 3600 }) => {
  try {
...
export const uploadFile: UploadHandler = async (file, path, { bucket, contentType }) => {
  try {
